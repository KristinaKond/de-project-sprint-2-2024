...
UNION
SELECT  t4.order_id,
        t4.order_created_date,
        t4.order_completion_date,
        t4.order_status,
        t4.craftsman_id,
        t4.craftsman_name,
        t4.craftsman_address,
        t4.craftsman_birthday,
        t4.craftsman_email,
        t4.product_id,
        t4.product_name,
        ...
        t5.customer_email
  FROM external_source.craft_products_orders t4
    JOIN external_source.customers t5 ON t4.customer_id = t5.customer_id 
    ;
